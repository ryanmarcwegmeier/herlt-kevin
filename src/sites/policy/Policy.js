            ...
            <div>
                 <div className="container-fluid" style={{height:"100vh"}}>
                  <div className="mt-3 pt-3 p-5 ">
                    ...
                    <div className="pt-3">
                        {ReactHtmlParser(Helper.translate("Privacy policy of this website created by the generator of Muster-Datenschutzerklärung von <a target='_blank' href='https://www.anwalt.de/'>https://www.anwalt.de/</a>",this.props.lang))}
                    </div>
                </div>
                </div>
