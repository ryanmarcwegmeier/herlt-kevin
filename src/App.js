    ...
    class App extends Component {
      ...
      createListView(links, cols){
        ...
        while (rows>=0){
          ...
          componentWillMount(){
           let images = [
           {"id":1,"type":"Logo", "title":"Der frische Backshop", "src":img1,"desc":"I developed this logo for a bakery in a petrol station Hessol in 2017 during my professional training in Euphorika."},
           {"id":2,"type":"Logo", "title":"Bebop", "src":img2,'desc':'This Logo was made for a fictional softdrink brand'},
           {"id":3,"type":"Logo", "title":"Elsa Brändström Haus", "src":img3,'desc':'This Logo was made for a international seminar and conference venue. It was created during my professional training in the agency Euphorika.'},
           {"id":4,"type":"Logo", "title":"Ernst Luftig Windparkwartung GmbH", "src":img4,'desc':'This Logo was made for a fictional wind farm maintenance company.'},
           {"id":5,"type":"Logo", "title":"Ham", "src":img5,'desc':'Random Logo'},
           {"id":6,"type":"Logo", "title":"Informatiger", "src":img6,'desc':'This Logo was made for a student council for electrical engineering and computer science. It was made back in 2017.This Logo was created during my professional training in Euphorika'},
           {"id":7,"type":"Logo", "title":"Kasangga Youth", "src":img7,'desc':'I designed this logo in 2018 for my basketball team Kasanagga Youth.'},
           {"id":8,"type":"Logo", "title":"Kevin Herlt", "src":img8,'desc':'I developed this logo for myself in 2018.'},
           {"id":9,"type":"Logo", "title":"Silk Darling", "src":img9,'desc':'I designed this Logo back in 2017 for a silk pillow company.'},
         ] 
          this.setState({imagearray:this.createListView(images,3)})
          
          images = [
            {"id":10,"type":"Print", "title":"Elsa Brändström Haus Pagedesign", "src":img10,'desc':'I designed the layout which is oriented to the webdesign. It was created during my professional training in Euphorika.'},
            {"id":11,"type":"Print", "title":"FSR Flyer", "src":img11,'desc':'I designed this flyer on customer request. It was created during my professional training in Euphorika.'},
            {"id":12,"type":"Print", "title":"Manager Magazin Illustration", "src":img12,'desc':'I created the background of this page. I used stock pictures for the Illustration. It was created during my professional training in Euphorika'},
            {"id":13,"type":"Print", "title":"OnlYours Poster", "src":img13,'desc':'I designed this Poster for a friend to help him for his school project.'},
            {"id":14,"type":"Print", "title":"Navis Heide Park invitation", "src":img14,'desc':"This invitation was for the company Navis who invited theiremployees to the amusement park 'Heide Park'. In this illustration, I have designed the compilation of the individual elements that come from Shutterstock."},
            {"id":15,"type":"Print", "title":"Silk Darling exhibitor", "src":img15,'desc':'This is a design for an exhibitor of Silk Darling. This layout was created during my training in Euphorika.'},
          ] 
           ...
           images = [
            {"id":21,"type":"Blender", "title":"3D Devil", "src":img21,'desc':'I created this devil with VR glasses in the program Oculus Medium. The details on 3D Blender.'},
            {"id":22, "type":"Blender", "title":"Silver Fences","src":img22,'desc':'It was created by myself and it was my first experience with 3D Blender.'},
