          ...
          return (
              ...
              <div className="container-fluid" style={{height:"100vh"}}>
                  <div className="mt-3 pt-3 p-5 ">
                    ...
                    <div className="pt-4">
                        {ReactHtmlParser(Helper.translate("Imprint of this website created by the generator of <a target='_blank' href='http://www.deutsche-anwaltshotline.de/recht-auf-ihrer-website/impressum-generator'>Deutsche Anwaltshotline AG</a>",this.props.lang))}
                    </div>
